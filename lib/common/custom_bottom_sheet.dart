...
class _ModalBottomSheet<T> extends StatefulWidget {
  const _ModalBottomSheet({Key key, this.route, this.onClosing, this.enableDrag}) : super(key: key);
  ...
  @override
  _ModalBottomSheetState<T> createState() => _ModalBottomSheetState<T>(onClosing, enableDrag: enableDrag);
}
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  Widget buildPage(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation) {
    ...
    Widget bottomSheet = MediaQuery.removePadding(
      context: context,
      removeTop: true,
      child: isStopAnimations
          ? _ModalBottomSheetWithoutAnimation<T>(
              builder: builder,
              onClosing: onClosing,
              enableDrag: enableDrag,
            )
...
Future<T> showCustomModalBottomSheet<T>({
  ...
  return Navigator.of(context, rootNavigator: rootNavigator).push(_ModalBottomSheetRoute<T>(
    isStopAnimations: isStopAnimation != null ? isStopAnimation : false,
    builder: builder,
    onClosing: onClosing,
    enableDrag: enableDrag != null ? enableDrag : true,
    barrierDismissibleValue: barrierDismissibleValue,
...
class _ModalBottomSheetWithoutAnimation<T> extends StatefulWidget {
  const _ModalBottomSheetWithoutAnimation({Key key, this.onClosing, this.enableDrag, this.builder}) : super(key: key);
  ...
  @override
  _ModalBottomSheetState1<T> createState() => _ModalBottomSheetState1<T>(onClosing, enableDrag: enableDrag);
}
      ...
      child: GestureDetector(
          ...
          child: AnimatedBuilder(
              ...
              builder: (BuildContext context, Widget child) {
                // Disable the initial animation when accessible navigation is on so
                // that the semantics are added to the tree at the correct time.
                final double animationValue = mediaQuery.accessibleNavigation ? 1.0 : curve.value;
                return Semantics(
                  scopesRoute: true,
                  namesRoute: true,
                  label: routeLabel,
